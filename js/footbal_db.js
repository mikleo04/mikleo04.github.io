let dbPromised = idb.open("Footbal", 2, function (upgradeDb) {
...
function saveFavTeam(data) {
    dbPromised.then(function (db) {
        ...
        .then(function () {
            ...
            console.log(title);
            const options = {
                body: `Club ${data.name} telah tersimpan, cek di halaman My Favorite.`,
            ...
            if (Notification.permission === "granted") {
                ...
                M.toast({
                    html: `Club ${data.name} telah disimpan, cek di halaman My Favorite.`,
                });
            }
        })
}
...
function deleteFavTeams(idTeam, nameTeam) {
    dbPromised
        ...
        .then(() => {
            ...
            const options = {
                'body': `${nameTeam} berhasil dihapus dari list My Favorite.`,
                badge: "../favicon-32x32.png",
                icon: "../favicon-32x32.png"
            };
            if (Notification.permission === 'granted') {
                ...
                M.toast({
                    html: `${nameTeam} berhasil dihapus dari list My Favorite`,
                });
            }
        })
}