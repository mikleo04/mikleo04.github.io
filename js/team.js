function setTeam(result) {
    ...
    team += `
        <div class="detail-team">
                ...
                <div class="container descriptions-team">
                    <ul>
    ...
    function cekFavTeams(items) {
        let subscribeTeam = `<div class"subscribe" id="subscribe" style="margin-top: 50px; margin-left: 30px;"><a class="btn-floating btn-large pulse blue"><i class="material-icons grey-text text-lighten-3">favorite</i></a></div>`
