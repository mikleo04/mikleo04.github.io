    ...
    function favTeam(result) {
        ...
        if (data.length == 0) {
            ...
            data.forEach(data => {
                listTeams += `
                <li>
                    <div class="collapsible-header grey lighten-3"><img src="${data.crestUrl}" alt="${data.name}" width="50" height="50" style="margin-right: 30px;"><span style="display: inline-block; margin-top: 20px;">${data.name}</span></div>
